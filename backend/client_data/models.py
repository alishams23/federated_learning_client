...
class ClientData(models.Model):
    ...
    status = models.CharField(max_length=50, choices=[('not_started', 'شروع نشده'),('pending', 'در حال پردازش'), ('processed', 'پردازش شده')], default='not_started',verbose_name="وضعیت")  # Data processing status
    server = models.ForeignKey(Server , verbose_name="سرور",on_delete=models.CASCADE)
